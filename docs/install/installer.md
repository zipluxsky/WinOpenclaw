...
| [Windows GUI installer](/install/windows-gui) | Windows (native)     | GUI .exe: install Node + OpenClaw, configure gateway/model/web, and run a security score check (no WSL).  |
